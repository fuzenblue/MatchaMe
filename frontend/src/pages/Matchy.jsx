...
const Matchy = () => {
    ...
    const generateBotResponse = async (history) => {
        ...
        หากแนะนำเมนูใด ให้แนบลิงก์ในรูปแบบนี้ด้วย:
        "/product/{_id}" โดย {_id} คือรหัสของเมนู
        ให้บอกชื่อ รส/กลิ่น และตามด้วยข้อความ:
        ดูรายละเอียดเพิ่มเติมได้ที่ "/product/{_id}" โดย {_id} คือรหัสของเมนู
